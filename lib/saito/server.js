...
*****/
  ...
  //   res.sendFile(this.web_dir + 'index.html');
  //   return;
  // });
  app.get('/options', (req, res) => {
    ...
    res.sendFile(this.web_dir + "client.options');
    return;
  });
  ...
  app.get('/browser.js', function (req, res) {
    ...
    //res.sendFile(this.web_dir + 'browser.js.gz');
    //
    ...
    res.setHeader("expires","-1");
    res.setHeader("pragma","no-cache");
    res.sendFile(this.web_dir + 'browser.js');
    //
    //  non-gzipped, cached
    //
    //res.setHeader("Cache-Control", "public");
  ...
  app.use(express.static(path.join(this.web_dir, 'web')));
