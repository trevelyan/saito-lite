...
class Transaction {
 ...
 // 0 = normal
	...
	for (let i = 0; i < this.transaction.from.length; i++) {
	  this.transaction.from[i] = new saito.slip(
	    this.transaction.from[i].add,
	    this.transaction.from[i].amt,
	    this.transaction.from[i].type,
	    this.transaction.from[i].bid,
	    this.transaction.from[i].tid,
	    this.transaction.from[i].sid,
	    this.transaction.from[i].bsh
	  );
	}

	for (let i = 0; i < this.transaction.to.length; i++) {
	  this.transaction.to[i] = new saito.slip(
	    this.transaction.to[i].add,
	    this.transaction.to[i].amt,
	    this.transaction.to[i].type,
	    this.transaction.to[i].bid,
	    this.transaction.to[i].tid,
	    this.transaction.to[i].sid,
	    this.transaction.to[i].bsh
	  );
	}
