...
console.log("BLOCK INDEX: " + this.index.blocks.length);
...
Blockchain.prototype.saveBlockchain = function saveBlockchain(blk) {
  ...
  this.app.options.blockchain.genesis_ts		= this.genesis.ts;
  this.app.options.blockchain.genesis_bid		= this.genesis.bid;
  this.app.options.blockchain.genesis_period		= this.genesis.period;
